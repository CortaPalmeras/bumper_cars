...
from libs.shaders import SimpleModelViewProjectionShaderProgram
...
# This file is used to generate the background image for the game. It is not used in the game itself.
